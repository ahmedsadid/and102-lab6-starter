...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.books_menu -> fragment = bestSellerBooksFragment
                R.id.articles_menu -> fragment = articleListFragment
            }
            replaceFragment(fragment as ArticleListFragment)
            true
        }

        // Set default selection
        bottomNavigationView.selectedItemId = R.id.books_menu
